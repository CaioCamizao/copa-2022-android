...
class MainViewModel @Inject constructor(
            ...
            .catch {
                when (it) {
                    is NotFoundException ->
                        sendAction(MainUiAction.MatchesNotFound(it.message ?: "Erro sem msg"))
    ...
    sealed interface MainUiAction {
        ...
        data class EnableNotification(val matches: MatchDomain) : MainUiAction
        data class DisableNotification(val matches: MatchDomain) : MainUiAction
    }